-- Submitted at: 878947465541/500, Name: complexshapeEmbeddingOpBoundaryleIffone
/-
...
@[simp, target] lemma op_boundaryLE_iff {j : ι} : e.op.BoundaryLE j ↔ e.BoundaryGE j := by sorry